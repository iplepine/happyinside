...
class AppColors {
  ...
  static const secondaryForeground = Color(0xFF2A2A00); // --secondary-foreground
  ...
  static const destructiveForeground = Color(0xFFFFFFFF); // --destructive-foreground
  ...
  static const sidebarPrimaryForeground = Color(0xFF2A2A00); // --sidebar-primary-foreground
  static const sidebarAccent = Color(0xFFFFF8C4); // --sidebar-accent
  static const sidebarAccentForeground = Color(0xFF2A2A00); // --sidebar-accent-foreground
  ...
  static const primaryForegroundDark = Color(0xFF2A2A00); // primary-foreground (dark)
  ...
  static const secondaryForegroundDark = Color(0xFFFFE135); // --secondary-foreground (dark)
  ...
  static const accentForegroundDark = Color(0xFFFFE135); // --accent-foreground (dark)
  static const destructiveDark = Color(0xFFE53E3E); // oklch(0.396 0.141 25.723)
  static const destructiveForegroundDark = Color(0xFFA23E3E); // oklch(0.637 0.237 25.331)
  ...
  static const sidebarAccentForegroundDark = Color(0xFFFFE135); // --sidebar-accent-foreground (dark)
